              ...
              <div className="space-y-2">
                {fastTrackQueue.map((issue) => (
                  <div key={issue.id} className="border border-border rounded-lg p-3">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">{issue.building || 'General'} • {issue.floor || 'Ground Floor'} • Room {issue.room || 'N/A'}</p>
                    <div className="mt-2">
                    ...
                    <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-3">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {issue.department || issue.category} / {issue.subCategory || issue.category} • {issue.building || 'General'} • {issue.floor || 'Ground Floor'} • Room {issue.room || 'N/A'}
                        </p>
