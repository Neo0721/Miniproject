...
export default function StaffRegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setShowSuccess(true)
      setTimeout(() => {
        router.push(`/staff/dashboard?name=${encodeURIComponent(formData.name)}&role=staff`)
      }, 2000)
    }, 1500)
  }
      ...
      <div className="min-h-screen bg-background flex items-center justify-center px-4 py-12">
        <Card className="p-8 text-center shadow-lg max-w-md w-full animate-fade-in-up">
          ...
          <p className="text-muted-foreground mb-6">
            Your staff account has been created. Redirecting to your dashboard...
          </p>
        </Card>
      </div>
    )
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="p-8 shadow-lg">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Create your staff account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
                className={`w-full px-3 py-2 border rounded-lg bg-background text-foreground ${errors.position ? 'border-red-500' : 'border-border'}`}
              >
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full bg-amber-600 hover:bg-amber-700 text-white text-base py-2 mt-6"
            >
