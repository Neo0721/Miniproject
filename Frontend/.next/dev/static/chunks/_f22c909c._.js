...
if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_USE_FIREBASE_EMULATOR === "true") {
    try {
...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            await signInWithEmailAndPassword(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], email, password);
            // Step 2: Verify token and get user info
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verifyToken"])();
            if (!result.success) {
                setErrors({
...
_s(LoginPage, "o23UbujRfvwnchJR71N2efdr/0U=", false, function() {
    return [
...
//# sourceMappingURL=_f22c909c._.js.map